...
private:
    ...
    void callback(socket_t socket, const struct sockaddr *from, size_t addrlen, mdns_entry_type_t entry,
                 uint16_t query_id, mdns_record_type rtype_n, mdns_class_t rclass, uint32_t ttl, const void *data,

...
void discovery::impl::callback(socket_t socket, std::shared_ptr<message_buffer> buf)
{
    message_parser parser(buf);
    ...
    if(parser.entry_type() == MDNS_RECORDTYPE_PTR)
    {
    ...
    else if(parser.entry_type() == MDNS_RECORDTYPE_SRV)
    {
    ...
    else if(parser.entry_type() == MDNS_RECORDTYPE_A)
    {
    ...
    else if(parser.entry_type() == MDNS_RECORDTYPE_AAAA)
    {
    ...
    else if(parser.entry_type() == MDNS_RECORDTYPE_TXT)
    {

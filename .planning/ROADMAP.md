...
- [ ] **Phase 2: recv_loop and AsioSocketPolicy** - Implement and test the shared async receive infrastructure and production ASIO socket policy
- [ ] **Phase 3: record_parser Free Functions** - Extract parser as pure byte-span transforms, isolate mdns.h to src/, add parser unit tests
- [ ] **Phase 4: Refactor service_discovery and querent** - Convert discovery and query types to policy-based templates returning accumulated std::expected results

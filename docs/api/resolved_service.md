...
- [service_discovery](service_discovery.md) -- discover and browse services (one-shot)
- [service_monitor](service_monitor.md) -- continuous service monitor (populates `wire_ttl` and `ttl_remaining`)

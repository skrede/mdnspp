...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    meta.record_offset = fdp.ConsumeIntegralInRange<size_t>(0, 32);
    meta.record_length = fdp.ConsumeIntegralInRange<size_t>(0, 32);
    meta.rtype = mdnspp::dns_type::aaaa;
    ...
    auto result = mdnspp::parse::aaaa(buf, meta);
    (void)result;

...
| 5.4 | QU/QM response routing | `[x]` | [quqm-routing.md](quqm-routing.md) |
...
| 6.1 | Negative responses (NSEC) | `[x]` | [negative-responses.md](negative-responses.md) |
| 6.7 | Legacy unicast responses | `[x]` | [legacy-unicast.md](legacy-unicast.md) |
...
| 8.1 | Simultaneous probe tiebreaking | `[x]` | [probing.md](probing.md): full §8.2 tiebreak with SRV rdata comparison |

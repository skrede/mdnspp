#ifndef AOS_TEST_TASKSPY_H
#define AOS_TEST_TASKSPY_H

#include "AutonomOS/Core/Scheduling/task.h"
...
public:
    ...
    void cycle(const Time &step) override;

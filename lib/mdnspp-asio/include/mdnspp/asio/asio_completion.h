...
// The entire content is guarded by MDNSPP_ENABLE_ASIO_POLICY so that headers
// including this file compile cleanly even when ASIO is not present in the build.
...
#endif // MDNSPP_ENABLE_ASIO_POLICY
